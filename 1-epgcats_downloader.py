...
if __name__ == '__main__':
    subprocess.call(
        ["rsync", "-azh", "--progress", "--stats", "/lab/epg_scm4_builds/program/ci/" + EPGCATS_VERSION + "/epgcats", TARGET_FOLDER, "-r"])
    subprocess.call(
        ["rsync", "-azh", "--progress", "--stats", "/lab/epg_scm4_builds/program/ci/" + EPGCATS_VERSION + "/vipp/test-tools.info", TARGET_FOLDER])
    subprocess.call(
